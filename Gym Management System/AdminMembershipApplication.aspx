<%@ Page Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminMembershipApplication.aspx.cs" Inherits="Gym_Management_System.AdminApproveMembers" %>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Application List</a>
          </div>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title "> Members Application</h4>
                  <p class="card-category"> Membership Application List</p>
                </div>
                <div class="card-body">
            ...
            <ItemTemplate>
                        ...
                        <td>
                            <a href="AdminApplicationDetails.aspx?id=<%#Eval("Applicationid") %>" class="btn btn-Secondary">Details</a>
                        </td>
                       
                            
                            <%-- <td>
                            <a href="AdminUpdateMember.aspx?id=<%#Eval("memberid") %>" class="btn btn-primary">Accept</a>
                        </td>
                        <td>
                            <a href="AdminDelete.aspx?type=Member&id=<%#Eval("memberid") %>" class="btn btn-danger">Decline</a>
                        </td>--%>
                        </tr>
