...
{
    public partial class AdminApproveMembers : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            getUser("select *,CONVERT(VARCHAR(10), Dob, 105) as d from MembershipApplication where status = 'PENDING'");
