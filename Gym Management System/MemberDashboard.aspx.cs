...
namespace Gym_Management_System
{
    public partial class MemberDashboard : System.Web.UI.Page
    {
        ...
        public void setData()
        {
                ...
                cmd = new SqlCommand("select firstname from TblTrainers where trainerid = (select trainerid from TblTrainerAllocation where memberid=@id)", con);
                ...
                if (dt.Rows.Count == 1)
                {
                    ...
                    {
                        LabelTrainer.Text = dr["firstname"].ToString();
                    }
                }
